  ...
  function handleActualizar(e){
    ...
    return(<>
      ...
      <Container className='navDesple'    maxWidth="false" >
       ...
       < button className="btnDesplegable" onClick={handleActualizar} myvalor={0} ><img myvalor={0}  src="/images/dashboardHome.svg" width="40vw"  alt="Home"/>  <h2 style={{fontSize:'1.5vw'}}>Dashboard</h2> </button>
